...
\subsection{Convert comments into clone chunks}
...
In this steps the \code{CloneResult}s get filtered so that possibly generated ones can easily be distinguished from the ones that are unlikely to be generated. This step is only to improve and speed up the later by hand performed search for generator patterns in the found clones.\\
...
\section{Accumulation of CloneResults}

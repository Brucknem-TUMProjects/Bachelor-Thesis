...
\centering
\begin{tikzpicture}[
scale = .8, transform shape, thick, TUMLightGray,
...
\end{tikzpicture}
\caption[The explicit suffix tree for the list of words "Do not modify \dots Do not modify\$".]{The explicit suffix tree for the list of words "Do not modify \dots Do not modify\$". The \$ symbol represents the added sentinel used to make the tree explicit. }
